...
public class MainActivity extends AppCompatActivity {
    ...
    public void grade(View view) {
        ...
        if (isQuestion5correct()) correctQuestions++;
    ...
    private boolean isQuestion1correct() {
        EditText mission = (EditText) findViewById(R.id.mission);
        //We could have simply used this line
//        return (mission.getText().toString().trim().toLowerCase().equals(
//                getResources().getString(R.string.sncf_mission).toLowerCase()))
        //the effect would have been the same
        if (mission.getText().toString().trim().toLowerCase().equals(
                getResources().getString(R.string.sncf_mission).toLowerCase()))
            return true;
        else
            return false;
    ...
    /**
     * Tell if the correct answer is selected on screen for question 5
     */
